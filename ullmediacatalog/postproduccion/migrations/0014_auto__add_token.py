...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Token'
        db.create_table('postproduccion_token', (
            ('video', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['postproduccion.Video'], unique=True)),
            ('token', self.gf('django.db.models.fields.CharField')(default='x72PuyAshz7XbCkLikpwMysjKxTQpV4gParnGgC27pzZSoU6EBpWGhIjljbd5H1WoR113AGYRgMZXANXZZ7qLlTlT04CL0IqklJWqkYXTygu3zIfWR2mLVDoMunbaAaf', max_length=128)),
            ('instante', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('postproduccion', ['Token'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Token'
        db.delete_table('postproduccion_token')
    ...
    models = {
        ...
        'postproduccion.token': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'x72PuyAshz7XbCkLikpwMysjKxTQpV4gParnGgC27pzZSoU6EBpWGhIjljbd5H1WoR113AGYRgMZXANXZZ7qLlTlT04CL0IqklJWqkYXTygu3zIfWR2mLVDoMunbaAaf'", 'max_length': '128'}),
            'video': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['postproduccion.Video']", 'unique': 'True'})
        },
