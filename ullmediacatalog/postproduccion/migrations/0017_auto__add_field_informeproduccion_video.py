...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InformeProduccion.video'
        db.add_column('postproduccion_informeproduccion', 'video', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['postproduccion.Video'], unique=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InformeProduccion.video'
        db.delete_column('postproduccion_informeproduccion', 'video_id')
