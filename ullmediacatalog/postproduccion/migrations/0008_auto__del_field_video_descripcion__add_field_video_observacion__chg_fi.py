...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.descripcion'
        db.delete_column('postproduccion_video', 'descripcion')

        # Adding field 'Video.observacion'
        db.add_column('postproduccion_video', 'observacion', self.gf('django.db.models.fields.TextField')(default=None), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Video.descripcion'
        db.add_column('postproduccion_video', 'descripcion', self.gf('django.db.models.fields.TextField')(default=None), keep_default=False)

        # Deleting field 'Video.observacion'
        db.delete_column('postproduccion_video', 'observacion')

        # Changing field 'Video.fecha_grabacion'
        db.alter_column('postproduccion_video', 'fecha_grabacion', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))
