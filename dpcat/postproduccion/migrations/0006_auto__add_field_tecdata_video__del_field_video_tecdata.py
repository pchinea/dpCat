...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TecData.video'
        db.add_column('postproduccion_tecdata', 'video', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['postproduccion.Video'], unique=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TecData.video'
        db.delete_column('postproduccion_tecdata', 'video_id')

        # Adding field 'Video.tecdata'
        db.add_column('postproduccion_video', 'tecdata', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['postproduccion.TecData'], unique=True, null=True, blank=True), keep_default=False)
