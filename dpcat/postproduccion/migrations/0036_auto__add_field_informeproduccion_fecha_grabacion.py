...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('postproduccion_informeproduccion', 'fecha_grabacion', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 6, 6, 12, 23, 40, 17295)), keep_default=False)
