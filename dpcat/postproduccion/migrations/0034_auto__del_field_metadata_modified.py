...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('postproduccion_metadata', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 6, 6, 11, 52, 32, 93344)), keep_default=False)
