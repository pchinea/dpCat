...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TipoVideo.alto'
        db.add_column('postproduccion_tipovideo', 'alto', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'TipoVideo.plantilla'
        db.add_column('postproduccion_tipovideo', 'plantilla', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['postproduccion.PlantillaFDV']), keep_default=False)

        # Adding field 'TipoVideo.ancho'
        db.add_column('postproduccion_tipovideo', 'ancho', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'TipoVideo.mix'
        db.add_column('postproduccion_tipovideo', 'mix', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=100), keep_default=False)

        # Adding field 'TipoVideo.x'
        db.add_column('postproduccion_tipovideo', 'x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'TipoVideo.y'
        db.add_column('postproduccion_tipovideo', 'y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TipoVideo.alto'
        db.delete_column('postproduccion_tipovideo', 'alto')

        # Deleting field 'TipoVideo.plantilla'
        db.delete_column('postproduccion_tipovideo', 'plantilla_id')

        # Deleting field 'TipoVideo.ancho'
        db.delete_column('postproduccion_tipovideo', 'ancho')

        # Deleting field 'TipoVideo.mix'
        db.delete_column('postproduccion_tipovideo', 'mix')

        # Deleting field 'TipoVideo.x'
        db.delete_column('postproduccion_tipovideo', 'x')

        # Deleting field 'TipoVideo.y'
        db.delete_column('postproduccion_tipovideo', 'y')
