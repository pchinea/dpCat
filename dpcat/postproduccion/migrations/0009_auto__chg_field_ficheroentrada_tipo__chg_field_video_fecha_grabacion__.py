...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FicheroEntrada.tipo'
        db.alter_column('postproduccion_ficheroentrada', 'tipo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postproduccion.TipoVideo'], null=True))

        # Changing field 'Video.fecha_grabacion'
        db.alter_column('postproduccion_video', 'fecha_grabacion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'Video.observacion'
        db.alter_column('postproduccion_video', 'observacion', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'FicheroEntrada.tipo'
        db.alter_column('postproduccion_ficheroentrada', 'tipo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postproduccion.TipoVideo']))

        # Changing field 'Video.fecha_grabacion'
        db.alter_column('postproduccion_video', 'fecha_grabacion', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Video.observacion'
        db.alter_column('postproduccion_video', 'observacion', self.gf('django.db.models.fields.TextField')())
