...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('postproduccion_video', 'autor', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.autor'
        db.alter_column('postproduccion_video', 'autor', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Video.titulo'
        db.alter_column('postproduccion_video', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=30))
