...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InformeProduccion.fecha_grabacion'
        db.delete_column('postproduccion_informeproduccion', 'fecha_grabacion')

        # Adding field 'InformeProduccion.fecha_produccion'
        db.add_column('postproduccion_informeproduccion', 'fecha_produccion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 6, 6, 11, 46, 1, 181242), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'InformeProduccion.fecha_grabacion'
        db.add_column('postproduccion_informeproduccion', 'fecha_grabacion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 6, 6, 11, 45, 36, 34222), blank=True), keep_default=False)

        # Deleting field 'InformeProduccion.fecha_produccion'
        db.delete_column('postproduccion_informeproduccion', 'fecha_produccion')
