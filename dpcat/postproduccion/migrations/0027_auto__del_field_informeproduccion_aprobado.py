...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InformeProduccion.aprobado'
        db.delete_column('postproduccion_informeproduccion', 'aprobado')
    
    
    def backwards(self, orm):
        
        # Adding field 'InformeProduccion.aprobado'
        db.add_column('postproduccion_informeproduccion', 'aprobado', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
