...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IncidenciaProduccion'
        db.create_table('postproduccion_incidenciaproduccion', (
            ...
            ('emisor', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('texto', self.gf('django.db.models.fields.TextField')()),
            ('aceptado', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('postproduccion', ['IncidenciaProduccion'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'IncidenciaProduccion'
        db.delete_table('postproduccion_incidenciaproduccion')
