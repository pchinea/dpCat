...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HistoricoCodificacion'
        db.create_table('postproduccion_historicocodificacion', (
            ...
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postproduccion.InformeProduccion'])),
        ))
        db.send_create_signal('postproduccion', ['HistoricoCodificacion'])

        # Deleting field 'InformeProduccion.comentario'
        db.delete_column('postproduccion_informeproduccion', 'comentario')
    
    
    def backwards(self, orm):
        
        # Deleting model 'HistoricoCodificacion'
        db.delete_table('postproduccion_historicocodificacion')

        # Adding field 'InformeProduccion.comentario'
        db.add_column('postproduccion_informeproduccion', 'comentario', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'postproduccion.incidenciaproduccion': {
            ...
            'aceptado': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
