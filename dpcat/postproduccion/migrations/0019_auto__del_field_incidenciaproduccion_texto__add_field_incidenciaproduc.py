...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'IncidenciaProduccion.texto'
        db.delete_column('postproduccion_incidenciaproduccion', 'texto')

        # Adding field 'IncidenciaProduccion.comentario'
        db.add_column('postproduccion_incidenciaproduccion', 'comentario', self.gf('django.db.models.fields.TextField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'IncidenciaProduccion.texto'
        db.add_column('postproduccion_incidenciaproduccion', 'texto', self.gf('django.db.models.fields.TextField')(default=0), keep_default=False)

        # Deleting field 'IncidenciaProduccion.comentario'
        db.delete_column('postproduccion_incidenciaproduccion', 'comentario')
