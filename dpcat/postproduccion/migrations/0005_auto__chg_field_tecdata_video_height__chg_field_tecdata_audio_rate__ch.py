...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TecData.video_height'
        db.alter_column('postproduccion_tecdata', 'video_height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'TecData.audio_rate'
        db.alter_column('postproduccion_tecdata', 'audio_rate', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'TecData.video_width'
        db.alter_column('postproduccion_tecdata', 'video_width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'TecData.bitrate'
        db.alter_column('postproduccion_tecdata', 'bitrate', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'TecData.video_height'
        db.alter_column('postproduccion_tecdata', 'video_height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'TecData.audio_rate'
        db.alter_column('postproduccion_tecdata', 'audio_rate', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'TecData.video_width'
        db.alter_column('postproduccion_tecdata', 'video_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'TecData.bitrate'
        db.alter_column('postproduccion_tecdata', 'bitrate', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
