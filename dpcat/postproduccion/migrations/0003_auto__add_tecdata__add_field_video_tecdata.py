...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TecData'
        db.create_table('postproduccion_tecdata', (
            ('video_color', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('audio_channels', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('video_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('video_bitrate', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('audio_rate', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('video_height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('video_rate', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('audio_bitrate', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('audio_codec', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('duration', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('video_codec', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('video_wh_ratio', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('bitrate', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('postproduccion', ['TecData'])

        # Adding field 'Video.tecdata'
        db.add_column('postproduccion_video', 'tecdata', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['postproduccion.TecData'], unique=True, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'TecData'
        db.delete_table('postproduccion_tecdata')

        # Deleting field 'Video.tecdata'
        db.delete_column('postproduccion_video', 'tecdata_id')
    ...
    models = {
        ...
        'postproduccion.video': {
            ...
            'tecdata': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['postproduccion.TecData']", 'unique': 'True', 'null': 'True'}),
