...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncidenciaProduccion.aceptado'
        db.alter_column('postproduccion_incidenciaproduccion', 'aceptado', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'IncidenciaProduccion.aceptado'
        db.alter_column('postproduccion_incidenciaproduccion', 'aceptado', self.gf('django.db.models.fields.BooleanField')(blank=True))
