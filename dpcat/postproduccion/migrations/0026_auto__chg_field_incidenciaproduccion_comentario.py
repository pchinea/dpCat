...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncidenciaProduccion.comentario'
        db.alter_column('postproduccion_incidenciaproduccion', 'comentario', self.gf('django.db.models.fields.TextField')(null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'IncidenciaProduccion.comentario'
        db.alter_column('postproduccion_incidenciaproduccion', 'comentario', self.gf('django.db.models.fields.TextField')())
