...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TecData.xml_data'
        db.alter_column('postproduccion_tecdata', 'xml_data', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'TecData.txt_data'
        db.alter_column('postproduccion_tecdata', 'txt_data', self.gf('django.db.models.fields.TextField')(null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'TecData.xml_data'
        db.alter_column('postproduccion_tecdata', 'xml_data', self.gf('django.db.models.fields.TextField')())

        # Changing field 'TecData.txt_data'
        db.alter_column('postproduccion_tecdata', 'txt_data', self.gf('django.db.models.fields.TextField')())
