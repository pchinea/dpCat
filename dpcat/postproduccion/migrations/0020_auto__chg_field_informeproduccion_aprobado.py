...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformeProduccion.aprobado'
        db.alter_column('postproduccion_informeproduccion', 'aprobado', self.gf('django.db.models.fields.BooleanField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'InformeProduccion.aprobado'
        db.alter_column('postproduccion_informeproduccion', 'aprobado', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True))
